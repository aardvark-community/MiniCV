...
int computePoses(const double featureVectors[3][3],
	const double worldPoints[3][3],
	cv::Matx33d* R_res, cv::Vec3d* t_res) {
	...
	for (int i = 0; i < 4; ++i) {
		...
		vect_sub(pxstheta1p, rp3, (double*)&t_res[nb_solutions]);
		...
		//R[nb_solutions][0][0] = R[0][0];
		//R[nb_solutions][1][0] = R[0][1];
		//R[nb_solutions][2][0] = R[0][2];
		//R[nb_solutions][0][1] = R[1][0];
		//R[nb_solutions][1][1] = R[1][1];
		//R[nb_solutions][2][1] = R[1][2];
		//R[nb_solutions][0][2] = R[2][0];
		//R[nb_solutions][1][2] = R[2][1];
		//R[nb_solutions][2][2] = R[2][2];
